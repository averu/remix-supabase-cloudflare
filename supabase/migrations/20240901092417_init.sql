...
CREATE UNIQUE INDEX "users_supabaseId_key" ON public.users USING btree ("supabaseId");
...
alter table "public"."todos" add constraint "todos_userId_fkey" FOREIGN KEY ("userId") REFERENCES users(id) ON UPDATE CASCADE ON DELETE RESTRICT not valid;
